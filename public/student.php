...
<?php include("../admin/slidebar.php"); ?>
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><img src="../img/gifs/alumno.gif" width="50 rem"> Usuario <small>Estudiante</small></h1>
			</div>
			<p class="lead">Recuerda que los estudiantes son el corazon de nuestra institucion, hay que tratarlos siempre con la mejor manera, los estudiantes tienen un acceso muy limitado a nuestra plataforma.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
						...
						<div class="tab-pane fade active in" id="new">
					  	...
					  	<div class="tab-pane fade" id="list">
							...
							<table class="table table-hover text-center">
									...
									<tbody>
										<?php
										$admin = mysqli_query($con, "SELECT * FROM usuarios WHERE rol LIKE 'alumno'");
