...
<?php include("../admin/slidebar.php"); ?>
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><img src="../img/gifs/maestro.gif" width="50 rem"> Usuario <small>Docente</small></h1>
			</div>
			<p class="lead">Los maestros son los encargados de cubrir el area de los curso, asi como los administradores tienen acceso a todos los apartados de software, un docente tiene limite en sus accesos</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
						...
						<div class="tab-pane fade active in" id="new">
					  	...
					  	<div class="tab-pane fade" id="list">
							...
							<table class="table table-hover text-center">
									...
									<tbody>
										<?php
										$admin = mysqli_query($con, "SELECT * FROM usuarios WHERE rol LIKE 'docente'");
